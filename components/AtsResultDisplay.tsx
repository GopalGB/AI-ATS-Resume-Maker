...
const AtsResultDisplay: React.FC<AtsResultDisplayProps> = ({ isLoading, result, error }) => {
  ...
  return (
    <div className="space-y-6 p-6 bg-base-100 border border-base-300 rounded-lg animate-fade-in">
        <h3 className="text-2xl font-semibold text-text-primary text-center">ATS Friendliness Report</h3>
        <div className="flex flex-col items-center gap-4">
            <ScoreCircle score={result.ats_score} />
            <p className="text-text-secondary text-center max-w-xl">{result.summary}</p>
        </div>
