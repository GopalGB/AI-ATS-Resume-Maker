...
// Fix: Correct import path for pdfGenerator
...
const ResultSection: React.FC<ResultSectionProps> = ({ isLoading, error, result }) => {
  if (isLoading) {
    return (
  ...
  return (
    <div className="bg-base-200/50 border border-base-300/50 rounded-2xl shadow-xl p-6 sm:p-8 space-y-8 animate-fade-in">
      <div className="flex flex-col items-center">
        <h2 className="text-3xl font-bold text-text-primary mb-6">Your Results</h2>
      ...
      <div className="space-y-8">
        <div>
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-2xl font-semibold text-text-primary">Tailored Resume</h3>
            <button
